...
auu = await Kibar(`https://api.brizaloka-api.tk/sociais/tiktok?apikey=brizaloka&url=${url}`)
res.json({
status: true,
código: 999,
criador: `Gabriel & Guilherme`,
resultado: {
url: `${url}`,
thumb: `${auu.imgUrl}`,
userName: `${auu.authorname}`,
titulo: `${auu.title}`,
audio: `${auu.urlDownloadMp3}`,
video: `${auu.urlDownloadMp4}`
}
})
})
