...
var { nerding, gpwhatsapp, apkmody, pornhubsrc, uptodown, igstalk, soundl, playstore, manga, anime, hentaistube, pornogratis, filme, wattpad } = require('./scraper.js')
...
var key = ["NezSab-Free_2023", "nezuko-cripto-2.0", "sabrina-cripto-2.0", "key-do-bielzinho-lindu", "key-da-daniela-totosa", "dayane", "key-do-josue-hetero", "key-taikinho-expr-2.6", "key-leonardo-keven-2.6", "key-do-victor-ofc-2.6", "key-rafael-expr-2.6", "key-jhonathan-marques-2.6", "key-jhon-totoso-2.6", "key-gabriel-stutis-2.6", "key-scheyot_user-vip3.5", "key-angelo-marques-2.6", "key-reeyzin-florzinha-2.6", "key-yuna-frosty-2.6", "key-do-tom-expr-2.6", "key-do-anonimo-2.6", "key-do-carlos-fofinha-jes", "key-do-yajiir-_", "key-rosa-nt-1.0", "Key-Do-Bruce-Expr_3.0-_-", "key-da-silvia-expr_3.3-_", "key-do-kevin-2024-3.4", "suporte-mauro_bronxys", "key-do-dark_light-md-3", "key-do-zalts_doctor-md-1", "key-do-lucas-sandiel_3.5-_", "KEY_", "key-do-thor-socaforte-3.5", "key-do-rick-_", "key-da-ariana-avila-3.6-_", "key-do-matheus-pereira-3.6-_", "key-do-yoshi_dls-3.6", "key-do-dark-_3.6-nzk", "key-do-carlos-henrique-nzk"]

var tokenc = ["dayane", "key-consultas-taiko_vip", "key-consultas-angelo_vip", "key-consultas-daniel_vip", "key-consultas-leonardo_vip", "key-consultas-kevin_vip", "key-consultas-jhonathan_vip", "key-consultas-toms_vip", "key-consultas-victor-ofc_vip", "key-consultas-victor_dn", "key-consultas-ryan_vip", "mauro_bronxys-user_vip", "scheyot-consultas_vip", "key-consultas-carlinhos_vip", "key-consultas-dark_vip", "key-consultas-lucas_vip", "rick_consultas-token", "key-consultas-matheus_vip"]
...
router.all('/api/tiktok', async (req, res) => {
url = req.query.url
if(!url)return res.json({
status:false,
motivo:'Coloque o parâmetro: url'
...
if(!apikey)return res.json({status:false,msg:'- Cadê o parâmetro apikey?'})
if(!key.includes(apikey))return res.json({status:false,msg:'Apikey Inválida, entre em contato: wa.me/5582988279194'})
auu = await Kibar(`https://saipulanuar.ga/api/download/tiktok4?url=${url}`)
hm = await Kibar(`https://tohka.tech/api/dl/tiktok?link=${url}&apikey=keyprem001`)
res.json({
status: true,
código: 999,
criador: `@nezsab-team`,
resultado: {
url: `${url}`,
curtidas: `${auu.result.likes}`,
comentários: `${auu.result.comments}`,
publicado: `${auu.result.publish}`,
capaVideo: `${hm.resultado.capa}`,
videoOriginal: `${hm.resultado.videoOriginal}`,
videoSemWt: `${hm.resultado.videoSemWt}`,
audio: `${hm.resultado.audio}`,
author: `${auu.result.author}`
}
})
})
...
app.get('/api/tiktokv2', async(req, res, next) => {
apikey = req.query.apikey
url = req.query.url
if(!apikey)return res.json({status:false,msg:'cade o parametro apikey'})
if(!key.includes(apikey))return res.json({status:false,msg:'Apikey Inválida, entre em contato: wa.me/5582988279194'})
if (!url) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro url?"}) 
  if(key.includes(apikey)){
    fetch(encodeURI(`https://app-lolizita-api.herokuapp.com/api/download/tiktok/?url=${url}&apikey=SuaApikey`))
...
if(!apikey)return res.json({status:false,msg:'cade o parametro apikey'})
if(!key.includes(apikey))return res.json({status:false,msg:'Apikey Inválida, entre em contato: wa.me/5582988279194'})
if (!q) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro q?"}) 
  if(key.includes(apikey)){
...
if(!apikey)return res.json({status:false,msg:'cade o parametro apikey'})
if(!key.includes(apikey))return res.json({status:false,msg:'Apikey Inválida, entre em contato: wa.me/5582988279194'})
if (!nome) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro nome?"}) 
  if(key.includes(apikey)){
...
if(!apikey)return res.json({status:false,msg:'cade o parametro apikey'})
if(!key.includes(apikey))return res.json({status:false,msg:'Apikey Inválida, entre em contato: wa.me/5582988279194'})
if (!text) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro text?"}) 
  if(key.includes(apikey)){
...
if(!apikey)return res.json({status:false,msg:'cade o parametro apikey'})
if(!key.includes(apikey))return res.json({status:false,msg:'Apikey Inválida, entre em contato: wa.me/5582988279194'})
if (!usuario) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro q?"}) 
  if(key.includes(apikey)){
    fetch(encodeURI(`https://api.brizaloka-api.tk/search/githubuser?apikey=brizaloka&query=${usuario}`))
    .then(response => response.json())
        .then(hasil => {
...
if (!query) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro query?"})
if(!apikey)return res.json({status:false,msg:'cade o parametro apikey'})
if(!key.includes(apikey))return res.json({status:false,msg:'Apikey Inválida, entre em contato: wa.me/5582988279194'})
...
if(!tokenc.includes(token))return res.json({status:false,msg:'Token inválido, entre em contato: wa.me/5582988279194'})
if (!nome) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro nome?"}) 
  if(tokenc.includes(token)){
...
if(!token)return res.json({status:false,msg:'Cadê o parametro token'})
if(!tokenc.includes(token))return res.json({status:false,msg:'Token inválido, entre em contato: wa.me/5582988279194'})
if (!cpf) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro cpf?"}) 
  if(tokenc.includes(token)){
...
if(!token)return res.json({status:false,msg:'Cadê o parametro token'})
if(!tokenc.includes(token))return res.json({status:false,msg:'Token inválido, entre em contato: wa.me/5582988279194'})
if (!telefone) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro telefone?"}) 
  if(tokenc.includes(token)){
...
if(!token)return res.json({status:false,msg:'Cadê o parametro token'})
if(!tokenc.includes(token))return res.json({status:false,msg:'Token inválido, entre em contato: wa.me/5582988279194'})
if (!cnpj) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro cnpj?"}) 
  if(tokenc.includes(token)){
...
if(!token)return res.json({status:false,msg:'Cadê o parametro token'})
if(!tokenc.includes(token))return res.json({status:false,msg:'Token inválido, entre em contato: wa.me/5582988279194'})
if (!cns) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro cns?"}) 
  if(tokenc.includes(token)){
...
if(!token)return res.json({status:false,msg:'Cadê o parametro token'})
if(!tokenc.includes(token))return res.json({status:false,msg:'Token inválido, entre em contato: wa.me/5582988279194'})
if (!placa) return res.json({ status : false, creator : `@nezsab-team`, message : "Cade o parametro placa?"}) 
  if(tokenc.includes(token)){
...
res.status(404).json({
status:false,
msg: '<❌️> Página não encontrada no servidor, entre em contato com o administrador!'
})
})
